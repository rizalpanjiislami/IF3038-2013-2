...
<table width="90%" border="0" cellspacing="1" cellpadding="1" align="center" id="outer">
  ...
  <tr height="30%">
    <td width="100%" bgcolor="#7190C9">
	  <p><img src="images2/backgroundlogo.jpg" width="100%" height="168"></p>
	  <form name="form1" method="POST" action="home.php?link=search">
	    <p align="center">
	   ...
	   <p align="center">Anda Login Sebagai <a href="home.php?link=halamanprofil&username=<?php echo $_COOKIE['username']; ?>"><img src="<?php echo $_COOKIE['foto'];?>" alt="" width="20" height="20"></a><a href="home.php?link=halamanprofil&username=<?php echo $_COOKIE['username']; ?>">
	     <?php
    ...
    <td>
		...
		<div id="can_pathway"> 
          <div align="center"><span class="pathway"><a href="home.php?link=selamatdatang">HOME</a> - <a href="home.php?link=halamanprofil&username=<?php echo $_COOKIE['username'];?>">MY PROFILE</a> - <a href="proseslogout.php">LOGOUT</a></span></div>
        </div>
		</td>
	  </tr>	
    </table></td>
...
<!------------------NAVIGASI END ------------------>
		<form name="form2" method="post" action="">
		  ...
		  $data5 = mysql_query("SELECT DISTINCT kategori FROM kategori");
		  
		  while($baris5=mysql_fetch_array($data5))
		  {
			  echo '<a href="">'.$baris5[0]."</a><br><br>";
			  ?>
			  <option value="<?php echo $baris5[0]; ?>"><?php echo $baris5[0]; ?></option>
              <?php
		  }
                                        ...
                                        <td valign="top" colspan="2">
										  <table width="100%" height="100%" border="0">
										   <tr>
										    <td>
										  <?php
										  if ($_GET['link']=="selamatdatang")    {require_once("selamatdatang.php");}
										  if ($_GET['link']=="halamanrinciantugas")    {require_once("halamanrinciantugas.php");}
										  if ($_GET['link']=="halamanprofil")    {require_once("halamanprofil.php");}
										  if ($_GET['link']=="editprofil")    {require_once("editprofil.php");}
										  if ($_GET['link']=="edittugas")    {require_once("edittugas.php");}
										   if ($_GET['link']=="search")    {require_once("search.php");}
										   if ($_GET['link']=="delete")    {require_once("delete.php");}
										   if ($_GET['link']=="tambahdata")    {require_once("tambahdata.php");}
										   if ($_GET['link']=="deletekomentar")    {require_once("deletekomentar.php");}
										  ?>
										  </td>
										   </tr>
										  </table>						  
